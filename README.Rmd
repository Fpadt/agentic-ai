...
- [Why MCP really is a big deal | Model Context Protocol with Tim Berglund](https://youtu.be/FLpS7OfD5-s?si=yEtR8H-eLfKPZ6YG)
...
This setup uses R & Python in the same Quarto document with virtual environments.
The virtual environments are setup with:
